...
function App() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      let seged=tombSeged[random1];
      tombSeged[random1]=tombSeged[random2];
      tombSeged[random2]=seged;
    }
    setTombKevert(tombSeged);
    console.log(tombSeged);
  }, []);
  return (
    <div className="App">
      <h1>Pályaorientáció</h1>
      <p>Ha pályaváltás, vagyis új, az eddigitől eltérő foglalkozás választása előtt áll, érdemes
